#include "StudentDB2.h"

#include <iostream>

void StudentDB2::load_students(const std::vector<Student>& students) {
...
std::string StudentDB2::op1_max_student_group() {
...
void StudentDB2::op2_change_group_by_email(const std::string& email, const std::string& new_group) {
...
std::string StudentDB2::op3_max_avg_rating_group() {
